...
j.each((function(l){if(!h[l]){h[l]=new Ext.tree.TreeNode({text:l,allowDrag:false,allowDrop:false,iconCls:"headerShapeRepImg",cls:"headerShapeRepChild",singleClickExpand:true});
c.appendChild(h[l]);
h[l].render()
