...
public class UiBinder {
   ...
   * @return
   */
  public boolean isBindable(String viewName) throws UiBinderException {
    ...
    InputStream resource = findUiResource(viewName,viewClass);
   ...
   * @return
   */
  private InputStream findUiResource(String viewName,Class viewClass) throws UiBinderException {
    ...
    if (resource == null)
    	throw new UiBinderException("Resource ["+viewDefinitionFile+"] cannot be found in : "+viewDefinitionFile);
