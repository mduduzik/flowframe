...
{
    //private static Log4jLoggerAdapter log = (Log4jLoggerAdapter) LoggerFactory.getLogger(LogWriter.class);
    ...
    private LogWriter()
    {
        ...
        //OFF: pentahoLogger.setAdditivity(false);

        PropertyConfigurator.configure(LogWriter.class.getClassLoader().getResource("logwriter/log4j.properties"));
        ...
        //
        //OFF: pentahoLogger.setLevel(Level.ALL);
...
/*        if (!consoleAppenderFound) {
        ...
        //
        //OFF: LogManager.getLogger("org.apache.commons.vfs").setLevel(Level.WARN);
    ...
    {
        //OFF: pentahoLogger.addAppender(appender);
    }

    public void removeAppender(Appender appender)
    {
        //OFF: pentahoLogger.removeAppender(appender);
    }
