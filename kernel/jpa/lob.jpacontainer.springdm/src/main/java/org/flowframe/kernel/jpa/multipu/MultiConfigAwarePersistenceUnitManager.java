package org.flowframe.kernel.jpa.multipu;
...
public class MultiConfigAwarePersistenceUnitManager extends DefaultPersistenceUnitManager {
    ...
    protected void postProcessPersistenceUnitInfo(MutablePersistenceUnitInfo pui) {
        ...
        logger.info("Processing to persistence unit [" + pui.getPersistenceUnitName() + "]");        
    ...
    public void setPersistenceUnitName(String persistenceUnitName) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Setting persistenceUnitName to [" + persistenceUnitName + "]");
        }        
    }
...
/*                if (logger.isDebugEnabled()) {
    ...
    private MutablePersistenceUnitInfo getMainPersistenceUnitInfo(MutablePersistenceUnitInfo pui) {
        if (logger.isDebugEnabled())
            logger.debug("getMainPersistenceUnitInfo: Checking PU[" + pui.getPersistenceUnitName() + "] if starts with ["+persistenceUnitName+"]");
    	if (strict) {
            if (logger.isDebugEnabled())
                logger.debug("getMainPersistenceUnitInfo PU[" + pui.getPersistenceUnitRootUrl() + "] as strict");        	
            ...
            if (logger.isDebugEnabled())
                logger.debug("getMainPersistenceUnitInfo: PU[" + pui.getPersistenceUnitName() + "] starts with ["+persistenceUnitName+"]");
