...
public class OrganizationDAOImpl implements IOrganizationDAOService {
	...
	public List<Organization> getAll() {
		return em.createQuery("select o from org.flowframe.kernel.common.mdm.domain.organization.Organization o record by o.id",Organization.class).getResultList();
	}
...
/*			TypedQuery<Organization> q = em.createQuery("select o from org.flowframe.kernel.common.mdm.domain.organization.Organization o WHERE o.code = :code",Organization.class);
