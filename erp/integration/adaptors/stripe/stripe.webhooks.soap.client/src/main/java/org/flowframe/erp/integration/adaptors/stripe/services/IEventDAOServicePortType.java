...
public interface IEventDAOServicePortType {
    ...
    @RequestWrapper(localName = "resetDB", targetNamespace = "http://services.stripe.adaptors.integration.erp.flowframe.org/", className = "org.flowframe.erp.integration.adaptors.stripe.services.ResetDB")
    @WebMethod
    @ResponseWrapper(localName = "resetDBResponse", targetNamespace = "http://services.stripe.adaptors.integration.erp.flowframe.org/", className = "org.flowframe.erp.integration.adaptors.stripe.services.ResetDBResponse")
    public void resetDB();
    ...
    @RequestWrapper(localName = "delete1", targetNamespace = "http://services.stripe.adaptors.integration.erp.flowframe.org/", className = "org.flowframe.erp.integration.adaptors.stripe.services.Delete1")
    @WebMethod
    @ResponseWrapper(localName = "delete1Response", targetNamespace = "http://services.stripe.adaptors.integration.erp.flowframe.org/", className = "org.flowframe.erp.integration.adaptors.stripe.services.Delete1Response")
    public void delete1(
        @WebParam(name = "arg0", targetNamespace = "")
        org.flowframe.erp.integration.adaptors.stripe.services.Event arg0
    );
