package org.flowframe.ui.pageflow.vaadin.ext.form;
...
public class VaadinCollapsibleConfirmActualsFormSectionHeader extends HorizontalLayout {
	...
	public VaadinCollapsibleConfirmActualsFormSectionHeader(ConfirmActualsFieldSetComponent fieldSet, Layout layout) {
		this.layout = layout;
