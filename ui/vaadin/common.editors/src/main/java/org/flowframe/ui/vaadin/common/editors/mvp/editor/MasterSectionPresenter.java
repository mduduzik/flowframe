...
import org.flowframe.ui.vaadin.common.editors.mvp.editor.view.IMasterSectionView;
import org.flowframe.ui.vaadin.common.editors.mvp.editor.view.MasterSectionView;
...
public class MasterSectionPresenter extends BasePresenter<IMasterSectionView, MasterSectionEventBus> implements IConfigurablePresenter,
		...
		if (this.contentPresenter == null) {
			if (this.getView().getContent() instanceof VaadinMatchGrid) {
				...
				if (container instanceof BeanItemContainer) {
					...
					EntityLineEditorEventBus lineEditorEventBus = ((ConfigurablePresenterFactory)this.factory.getPresenterFactory()).getEventBusManager()
	...
	public void onConfigure(Map<String, Object> params) throws Exception {
		...
		if (this.componentModel != null) {
			...
			EventBus mleEventBus = ((ConfigurablePresenterFactory)this.factory.getPresenterFactory()).getEventBusManager().getEventBus(MultiLevelEditorEventBus.class);
			if (mleEventBus != null) {
			...
			if (this.contentPresenter != null) {
				...
				final Component contentComponent = null;//this.factory.createComponent(this.componentModel);
					...
					if (((VaadinMatchGrid) contentComponent).getComponentModel().isDynamic()) {
						...
						newEntityButton.addListener(new ClickListener() {
							...
							public void buttonClick(ClickEvent event) {
								...
								assert (((ConfigurablePresenterFactory)MasterSectionPresenter.this.factory.getPresenterFactory()).getEventBusManager() != null);
								...
								try {
									...
									EntityLineEditorEventBus eventBus = ((ConfigurablePresenterFactory)MasterSectionPresenter.this.factory.getPresenterFactory()).getEventBusManager().getEventBus(EntityLineEditorEventBus.class);
									if (eventBus != null) {
