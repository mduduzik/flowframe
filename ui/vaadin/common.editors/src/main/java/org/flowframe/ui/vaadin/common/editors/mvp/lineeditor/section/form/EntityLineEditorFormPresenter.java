package org.flowframe.ui.vaadin.common.editors.mvp.lineeditor.section.form;
...
import org.flowframe.ui.vaadin.common.editors.mvp.lineeditor.section.form.header.EntityLineEditorFormHeaderEventBus;
import org.flowframe.ui.vaadin.common.editors.mvp.lineeditor.section.form.view.EntityLineEditorFormView;
import org.flowframe.ui.vaadin.common.editors.mvp.lineeditor.section.form.view.IEntityLineEditorFormView;
		...
		if (this.getView().getForm().saveForm()) {
			if (this.getView().getForm().getItemDataSource() instanceof BeanItem<?>) {
				...
				if (!isNewLineEditor) {
					...
					this.pageDataBuilder.saveNewInstance(bean, this.daoProvider, ((ConfigurablePresenterFactory)this.factory.getPresenterFactory()).getEventBusManager(), this.config);
				}
			}
