...
import org.flowframe.ui.vaadin.common.editors.mvp.lineeditor.view.IEntityLineEditorView;
...
public class EntityLineEditorPresenter extends BasePresenter<IEntityLineEditorView, EntityLineEditorEventBus> implements
	...
	private IComponentModelFactory presenterFactory;
	...
	public void onConfigure(Map<String, Object> params) {
		...
		this.presenterFactory = (IComponentModelFactory) params.get(IComponentFactory.VAADIN_COMPONENT_FACTORY);
		this.config = params;
