...
import org.flowframe.ui.vaadin.addons.common.gwt.client.ui.VFlowFrameMenuBar;
...
@ClientWidget(value = VFlowFrameMenuBar.class, loadStyle = LoadStyle.LAZY)
public class FlowFrameMenuBar extends AbstractComponent {
    ...
    private VFlowFrameMenuBar dummyVar;
     ...
     */
    public FlowFrameMenuBar.MenuItem addItem(String caption, FlowFrameMenuBar.Command command) {
     ...
     * @throws IllegalArgumentException
     */
    public FlowFrameMenuBar.MenuItem addItem(String caption, Resource icon,
            FlowFrameMenuBar.Command command) {
        if (caption == null) {
     ...
     * @throws IllegalArgumentException
     */
    public FlowFrameMenuBar.MenuItem addItemBefore(String caption, Resource icon,
            FlowFrameMenuBar.Command command, FlowFrameMenuBar.MenuItem itemToAddBefore) {
        if (caption == null) {
            throw new IllegalArgumentException("caption cannot be null");
        }
     ...
     */
    public void removeItem(FlowFrameMenuBar.MenuItem item) {
        if (item != null) {
    ...
    public interface Command extends Serializable {
        public void menuSelected(FlowFrameMenuBar.MenuItem selectedItem);
    }
    ...
    public class MenuItem implements Serializable {
         ...
         * @throws IllegalArgumentException
         */
        public MenuItem(String caption, Resource icon, FlowFrameMenuBar.Command command) {
            if (caption == null) {
                throw new IllegalArgumentException("caption cannot be null");
            }
            itsId = ++numberOfItems;
         ...
         * @since 6.2.0
         */
        public FlowFrameMenuBar.MenuItem addSeparator() {
            MenuItem item = addItem("", null, null);
            item.setSeparator(true);
            return item;
        }

        public FlowFrameMenuBar.MenuItem addSeparatorBefore(MenuItem itemToAddBefore) {
         ...
         */
        public FlowFrameMenuBar.MenuItem addItem(String caption, Resource icon,
                FlowFrameMenuBar.Command command) throws IllegalStateException {
            if (isSeparator()) {
         ...
         */
        public FlowFrameMenuBar.MenuItem getParent() {
            return itsParent;
        }
         ...
         */
        public void setCommand(FlowFrameMenuBar.Command command) {
            itsCommand = command;
        }
         ...
         *            The item to be removed
         */
        public void removeChild(FlowFrameMenuBar.MenuItem item) {
         ...
         *            The parent item
         */
        protected void setParent(FlowFrameMenuBar.MenuItem parent) {
            itsParent = parent;
        }
