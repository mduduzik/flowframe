 ...
 */
@Deprecated
public class VFlowFrameQuickLaunchMenuItem extends UIObject implements HasHTML {

    private static final String DEPENDENT_STYLENAME_SELECTED_ITEM = "selected";

    private Command command;
    private VFlowFrameQuickLaunchMenu parentMenu, subMenu;
     ...
     */
    public VFlowFrameQuickLaunchMenuItem(String text, Command cmd) {
        this(text, false);
        setCommand(cmd);
    }
     ...
     *            the command to be fired when it is selected
     */
    public VFlowFrameQuickLaunchMenuItem(String text, boolean asHTML, Command cmd) {
        this(text, asHTML);
        setCommand(cmd);
    }
     ...
     */
    public VFlowFrameQuickLaunchMenuItem(String text, VFlowFrameQuickLaunchMenu subMenu) {
        this(text, false);
        setSubMenu(subMenu);
    }
     ...
     *            the sub-menu to be displayed when it is selected
     */
    public VFlowFrameQuickLaunchMenuItem(String text, boolean asHTML, VFlowFrameQuickLaunchMenu subMenu) {
        this(text, asHTML);
        setSubMenu(subMenu);
    }

    VFlowFrameQuickLaunchMenuItem(String text, boolean asHTML) {
     ...
     */
    public VFlowFrameQuickLaunchMenu getParentMenu() {
        return parentMenu;
    }
     ...
     */
    public VFlowFrameQuickLaunchMenu getSubMenu() {
        return subMenu;
    }
     ...
     */
    public void setSubMenu(VFlowFrameQuickLaunchMenu subMenu) {
    ...
    void setParentMenu(VFlowFrameQuickLaunchMenu parentMenu) {
