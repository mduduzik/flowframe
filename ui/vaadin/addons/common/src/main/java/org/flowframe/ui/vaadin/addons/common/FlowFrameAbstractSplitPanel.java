...
public abstract class FlowFrameAbstractSplitPanel extends AbstractLayout {
	...
	private Set<ISplitPositionChangeListener> splitPositionChangeListeners = new HashSet<FlowFrameAbstractSplitPanel.ISplitPositionChangeListener>();
