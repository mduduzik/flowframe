 ...
 */
@Deprecated
public class VFlowFrameQuickLaunchMenu extends Widget implements PopupListener {

    private final Element body;
    private final ArrayList<VFlowFrameQuickLaunchMenuItem> items = new ArrayList<VFlowFrameQuickLaunchMenuItem>();
    private VFlowFrameQuickLaunchMenu parentMenu;
    private PopupPanel popup;
    private VFlowFrameQuickLaunchMenuItem selectedItem;
    private VFlowFrameQuickLaunchMenu shownChildMenu;
     ...
     */
    public VFlowFrameQuickLaunchMenu() {
        this(false);
    }
     ...
     */
    public VFlowFrameQuickLaunchMenu(boolean vertical) {
        super();
     ...
     */
    public void addItem(VFlowFrameQuickLaunchMenuItem item) {
        Element tr;
        if (vertical) {
            tr = DOM.createTR();
            DOM.appendChild(body, tr);
     ...
     */
    public VFlowFrameQuickLaunchMenuItem addItem(String text, boolean asHTML, Command cmd) {
        final VFlowFrameQuickLaunchMenuItem item = new VFlowFrameQuickLaunchMenuItem(text, asHTML, cmd);
        addItem(item);
        return item;
    }
     ...
     * @return the {@link MenuItem} object created
     */
    public VFlowFrameQuickLaunchMenuItem addItem(String text, boolean asHTML, VFlowFrameQuickLaunchMenu popup) {
        final VFlowFrameQuickLaunchMenuItem item = new VFlowFrameQuickLaunchMenuItem(text, asHTML, popup);
        addItem(item);
        return item;
    }
     ...
     * @return the {@link MenuItem} object created
     */
    public VFlowFrameQuickLaunchMenuItem addItem(String text, Command cmd) {
        final VFlowFrameQuickLaunchMenuItem item = new VFlowFrameQuickLaunchMenuItem(text, cmd);
        addItem(item);
        return item;
    }
     ...
     * @return the {@link MenuItem} object created
     */
    public VFlowFrameQuickLaunchMenuItem addItem(String text, VFlowFrameQuickLaunchMenu popup) {
        final VFlowFrameQuickLaunchMenuItem item = new VFlowFrameQuickLaunchMenuItem(text, popup);
        addItem(item);
        return item;
    }
    ...
    public void onBrowserEvent(Event event) {
        ...
        final VFlowFrameQuickLaunchMenuItem item = findItem(DOM.eventGetTarget(event));
     ...
     *         bar
     */
    protected List<VFlowFrameQuickLaunchMenuItem> getItems() {
        return items;
    }
     ...
     */
    protected VFlowFrameQuickLaunchMenuItem getSelectedItem() {
        return selectedItem;
    }
    ...
    void closeAllParents() {
        VFlowFrameQuickLaunchMenu curMenu = this;
        while (curMenu != null) {
            curMenu.close();
     ...
     */
    void doItemAction(final VFlowFrameQuickLaunchMenuItem item, boolean fireCommand) {
    ...
    void itemOver(VFlowFrameQuickLaunchMenuItem item) {
        if (item == null) {
    ...
    void selectItem(VFlowFrameQuickLaunchMenuItem item) {
    ...
    private VFlowFrameQuickLaunchMenuItem findItem(Element hItem) {
        for (int i = 0; i < items.size(); ++i) {
            final VFlowFrameQuickLaunchMenuItem item = items.get(i);
