...
@com.vaadin.ui.ClientWidget(org.flowframe.ui.vaadin.addons.common.gwt.client.ui.VFlowFrameQuickLaunchBox.class)
public class FlowFrameQuickLaunchBox extends Select {
    ...
    public FlowFrameQuickLaunchBox() {
        setMultiSelect(false);
        setNewItemsAllowed(false);
    }

    public FlowFrameQuickLaunchBox(String caption, Collection<?> options) {
        super(caption, options);
        setMultiSelect(false);
        setNewItemsAllowed(false);
    }

    public FlowFrameQuickLaunchBox(String caption, Container dataSource) {
        super(caption, dataSource);
        setMultiSelect(false);
        setNewItemsAllowed(false);
    }

    public FlowFrameQuickLaunchBox(String caption) {
        super(caption);
        setMultiSelect(false);
        setNewItemsAllowed(false);
    }
