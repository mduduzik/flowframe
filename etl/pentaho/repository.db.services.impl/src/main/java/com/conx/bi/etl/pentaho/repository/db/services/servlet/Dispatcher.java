package com.conx.bi.etl.pentaho.repository.db.services.servlet;

import com.conx.bi.etl.pentaho.repository.db.services.Identity;
import com.conx.bi.etl.pentaho.repository.db.services.handler.HandlerBase;
import com.conx.bi.etl.pentaho.repository.db.services.util.ExportInfo;
import com.conx.bi.etl.pentaho.repository.db.services.util.HandlerInfo;
import com.conx.bi.etl.pentaho.repository.db.services.business.User;
import com.conx.bi.etl.pentaho.repository.db.services.business.Model;
    ...
    public Collection<String> getHandlerClassNames() {
        ...
        for (File source : handlerDir.listFiles()) {
            if (source.getName().endsWith(".class")) {
                classNames.add("com.conx.bi.etl.pentaho.repository.db.services.handler." + source.getName().substring(0, source.getName().lastIndexOf(".")));
            }
        }
        return classNames;
    }
