...
public class RepoFileToResult extends BaseStep implements StepInterface
{
	...
	public RepoFileToResult(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
