 ...
 */
public class TransMetaDTO extends BaseDTO {
    private String name;
    ...
    public TransMetaDTO(TransMeta transMeta, String dirPathId, String jsonModel, String svgModel) {
        this(transMeta);
    ...
    public TransMetaDTO(TransMeta transMeta) {
