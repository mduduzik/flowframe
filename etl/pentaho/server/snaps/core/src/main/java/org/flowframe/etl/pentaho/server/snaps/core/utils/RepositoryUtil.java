package org.flowframe.etl.pentaho.server.snaps.core.utils;
...
public class RepositoryUtil {
    ...
    static public DatabaseMeta getDatabase(ICustomRepository repo, String pathID) {
        // /trans/1/database/2
        String[] pathTokens = pathID.split("/");
        int len = pathTokens.length;
    ...
    static public RepositoryDirectoryInterface getDirectory(ICustomRepository repo, ObjectId objId) throws KettleException {
        return repo.findDirectory(objId);
    }

    static public RepositoryDirectoryInterface getDirectory(ICustomRepository repo, String pathID) {
        String[] pathTokens = pathID.split("/");
