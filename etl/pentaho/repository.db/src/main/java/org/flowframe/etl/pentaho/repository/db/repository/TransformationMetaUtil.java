...
public class TransformationMetaUtil {
    ...
    static public Boolean csvStepMetaExists(CustomRepository repo, String dirId, String stepName) throws KettleException {
    ...
    static public Boolean stepMetaExists(CustomRepository repo, RepositoryDirectoryInterface dir, String stepInputPid, String stepName) throws KettleException {
