...
ORYX.ETL.ShapeDataPresenter = {
    ...
    getFacade: function() {
        ...
        if(!(this._getFacade))
            // create it.
            this._getFacade = {
                registerShape: this._registerShape.bind(this),
     ...
     */
    //}
    ,_registerShape: function(shape) {
        this.shape = shape;
    }
}
ORYX.ETL.ShapeDataPresenter = Clazz.extend(ORYX.ETL.ShapeDataPresenter);