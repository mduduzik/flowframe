...
ORYX.CONFIG.ETL_METADATA_EDITORS_CONFIG =			ORYX.CONFIG.ROOT_PATH + "plugins/etl/metadata/metadataplugins.xml";
...
ORYX.CONFIG.EVENT_SHAPE_REPOSITORY_CHANGE =  "onShapeRepositoryChange";
...
ORYX.CONFIG.EVENT_CANVAS_CHANGED =		"canvasChanged";
...
//-- ETL
ORYX.CONFIG.EVENT_ETL_STEP_EDIT_LABEL = "etl.step.edit.label";

ORYX.CONFIG.ETL_METADATA_TYPE_CSVMETA = "CsvInput";
ORYX.CONFIG.ETL_METADATA_TYPE_EXCELMETA = "ExcelInput";
ORYX.CONFIG.ETL_METADATA_TYPE_DELIMTEDMETA = "TextFileInput";
ORYX.CONFIG.ETL_METADATA_TYPE_DATABASE = "DataBase";
...
ORYX.CONFIG.EVENT_ETL_STEP_EDIT_PREFIX       = "etl.step.edit.";
...
ORYX.CONFIG.EVENT_ETL_STEP_DELETE_PREFIX       = "etl.step.delete.";
ORYX.CONFIG.EVENT_ETL_METADATA_DDROP = "etl.metadata.ddrop.";
ORYX.CONFIG.EVENT_ETL_METADATA_SAVED       = "etl.metadata.saved";


//---- Doc Repository
ORYX.CONFIG.EVENT_ETL_DOCREPOSITORY_DDROP = "etl.docrepoitem.ddrop.";
