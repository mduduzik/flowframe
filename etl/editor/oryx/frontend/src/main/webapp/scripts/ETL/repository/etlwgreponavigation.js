...
ORYX.ETL.ETLWorkGroupRepoNavigation = Clazz.extend({
    ...
    construct: function (application) {
        ...
        if (!this.navigationPanel) {
            var treeLoader = new Ext.tree.TreeLoader({
                requestMethod: 'GET',
                clearOnLoad: false,
                dataUrl: '/etl/core/explorer/wg/getnode',
...
*/
            ...
            try {
                var region = this.application.addToRegion("west", this.navigationPanel, "Work Groups");
            }
            catch (e) {
                ORYX.Log.error(e);
            }
            ...
            items: [
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        Ext.Ajax.request({
                            url: '/etl/core/explorer/wg/deletedir',
                            method: 'DELETE',
                ...
                new Ext.menu.Separator({cmd:'sep-open'}),
                {
                    ...
                    handler: function () {
                        ...
                        this.createNewDir(this.ctxNode,{
                            url:'/etl/core/explorer/wg/adddir',
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        this.deleteDir(this.ctxNode,{
                            url:'/etl/core/explorer/wg/deldir',
                            itemtype: 'transformation'
                        });
                    }.bind(this)
                },
