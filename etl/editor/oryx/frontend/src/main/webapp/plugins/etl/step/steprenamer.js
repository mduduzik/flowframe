...
ORYX.Plugins.ETL.Step.StepRenamer = Clazz.extend({
    ...
    construct: function(facade){
		...
		this.facade.registerOnEvent(ORYX.CONFIG.EVENT_ETL_STEP_EDIT_LABEL, this.actOnLabelEditing.bind(this));
        this.facade.offer({
		 keyCodes: [{
				keyCode: 113, // F2-Key
	...
	renamePerF2 : function renamePerF2() {
		...
		this.actOnLabelEditing(undefined, selectedShapes.first());
	},
	...
	actOnLabelEditing: function actOnLabelEditing(evt, shape){
