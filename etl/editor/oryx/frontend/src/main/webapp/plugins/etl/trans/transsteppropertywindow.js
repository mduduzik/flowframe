...
if (!ORYX.Plugins.ETL.Trans.Step) {
    ORYX.Plugins.ETL.Trans.Step = new Object();
}

ORYX.Plugins.ETL.Trans.Step.TransStepPropertyWindow = {
    canvas: undefined,
    facade: undefined,
...
ORYX.Plugins.ETL.Trans.Step.TransStepPropertyWindow = Clazz.extend(ORYX.Plugins.ETL.Trans.Step.TransStepPropertyWindow);