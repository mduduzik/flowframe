...
ORYX.Plugins.ETL.Metadata.CSVMetaEditor = {
    ...
    construct: function (eventManager) {
        ...
        this.eventManager.registerOnEvent(ORYX.CONFIG.EVENT_ETL_METADATA_CREATE_PREFIX + 'CSVMeta', this.onCreate.bind(this));
        this.eventManager.registerOnEvent(ORYX.CONFIG.EVENT_ETL_METADATA_EDIT_PREFIX + 'CSVMeta', this.onEdit.bind(this));
        this.eventManager.registerOnEvent(ORYX.CONFIG.EVENT_ETL_METADATA_DELETE_PREFIX + 'CSVMeta', this.onDelete.bind(this));
    },
