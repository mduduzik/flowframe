...
Ext.ux.tot2ivn.VrTabPanel = Ext.extend(Ext.Panel,  {
    ...
    afterRender : function(){
        ...
        if(this.activeTab !== undefined){
            var item = (this.activeTab) ? this.activeTab : this.items.get(this.activeTab);
    ...
    initEvents : function(){
        ...
        this.on('mousedown',this.onStripMouseDown,this);
        this.on('contextmenu',this.onStripContextMenu,this);
        if(this.enableTabScroll){
            this.on('mousewheel',this.onWheel,this);
