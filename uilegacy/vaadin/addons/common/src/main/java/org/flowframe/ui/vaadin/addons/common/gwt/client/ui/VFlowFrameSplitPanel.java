...
public class VFlowFrameSplitPanel extends ComplexPanel implements Container, ContainerResizedListener {
    ...
    public VFlowFrameSplitPanel() {
        this(ORIENTATION_HORIZONTAL);
    }

    public VFlowFrameSplitPanel(int orientation) {
