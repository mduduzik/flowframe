package org.flowframe.ui.vaadin.common.editors.mvp.editor.grid;
...
import org.flowframe.ui.vaadin.common.editors.mvp.editor.grid.view.EditorGridView;
import org.flowframe.ui.vaadin.common.editors.mvp.editor.grid.view.IEditorGridView;
...
public class EditorGridPresenter extends
	...
	public void onConfigure(Map<String, Object> params) {
		...
		this.mainApplication = (IEntityContainerProvider) params
				.get(IComponentFactory.FACTORY_PARAM_MAIN_APP);
		this.factory = (IComponentModelFactory) params
	...
	public void onEdit(Item item) {
		MultiLevelEditorEventBus ownerEditorEventBus = ((ConfigurablePresenterFactory)this.factory
	...
	private void doCreate() throws InstantiationException,
		...
		if (this.tableComponent.getRecordEditor() != null) {
			MultiLevelEditorEventBus eventBus = ((ConfigurablePresenterFactory)this.factory
					.getPresenterFactory()).getEventBusManager()
					.getEventBus(MultiLevelEditorEventBus.class);
