package org.flowframe.ui.services.data;
...
public interface IEditorDataManager {
	...
	public void applyParamData(Map<String, Object> config, Component component, Map<String, Object> params, Object presenterFactory) throws Exception;
