...
public class BeanDataSource extends DataSource {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4727461402499450527L;

	@ManyToOne
	private BeanDataSource superDataSource = null;
	...
	public BeanDataSource(String code, EntityType entityType) {
		super();
		setCode(code);
		setName(code);
		this.entityType = entityType;
	...
	public BeanDataSource getSuperDataSource() {
		return superDataSource;
	}

	public void setSuperDataSource(BeanDataSource superDataSource) {
